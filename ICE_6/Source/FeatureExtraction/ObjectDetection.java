...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/food.mkv"));
        int count1 = 0, count2 = 0, count3 = 0;
       // String o1 = "output/features.txt";
        String o1 = "output1/features.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/testtacos.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/chapolaas.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/waffle.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
